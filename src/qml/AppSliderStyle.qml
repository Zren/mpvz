/*
Forked version that references our forked AppSlider instead of Slider
so that there is no type casting error on the control property.
*/
...
Style {
	...
	readonly property AppSlider control: __control
